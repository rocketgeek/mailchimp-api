<?php
/**
 * MailChimp API v3 wrapper for WordPress appliations.
 *
 ...
 * This class: https://github.com/butlerblog/mailchimp-api
 * Drew's class: https://github.com/drewm/mailchimp-api
 *
 * @author Chad Butler
 * @version 1.0.0
 */
class WP_Members_MailChimp_API {
	...
	public function __construct( $api_key ) {
		...
		if ( strpos( $this->api_key, '-' ) === false ) {
			wp_die( __( 'Invalid MailChimp API key supplied.' ) );
		}
	...
	public function new_batch( $batch_id = null ) {
		return new WP_Members_MailChimp_API_Batch( $this, $batch_id );
	}
